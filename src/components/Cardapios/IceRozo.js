...
class IceRozo extends Component {
  state = {
    expanded: false,
    timeoutId: null
  };
    ...
    <div className="cardapio">
      ...
      <Paper className={classes.root}>
        <div className="font-lista cabecalho">
          <img src={IceRozoLogo}  className="img-header" alt="Ice Rozo logo"/>
          Ice Rozo
        </div>    
      ...
      {/* <EnviarMensagem numero="556599336878" /> */}
...
export default withStyles(styles)(IceRozo);